                ...
                <Modal.Body >
                    ...
                    <div className={style.ContenedorModal}>
                        <div className={style.BoxModalImagen}>
                            <Image className={style.FotoModalGarantiza} alt='FotoModal' src={modalGarantiza} />
                        </div>
                        <div className={style.BoxModalInfoCeleste}>
                            <div className={style.SubBoxInfoModal}>
                                ...
                                <Button href='/' className={style.buttonModal} onClick={props.onHide}>OK</Button>
                            </div>
                        </div>
                    </div>
                </Modal.Body>
            ...
            <form id="formulario2" className={style.ContainerAccordionInmoYPropie} onSubmit={handleSubmit(onSubmit2)}>
                <Accordion style={{ backgroundColor: 'transparent !important' }} className={style.AccordionInmoYPropie} >
                    <Accordion.Item className={style.AccordionItem} eventKey="0" >
                        <Accordion.Header className={style.AccordionHeader}  >Garantizá tu propiedad</Accordion.Header>
                        <Accordion.Body className={style.AccordionBodyInmoYPropie} >
                            <div className={style.BoxSelectInmoYPropie}>
                                <div className="input-wrapper">
                                    <label htmlFor="nombre-garantiza" className='label-accordion' style={{ width: "max-content" }} >Nombre/s</label>
                                    <input className='input-accordion' type="text" name='Nombre' {...register('Nombre', { required: "Campo Requerido", })} />
                                    {errors.Nombre && (<p className="text-danger">{errors.Nombre.message}</p>)}
                                </div>
                                <div className="input-wrapper">
                                    <label htmlFor="apellido-garantiza" className='label-accordion' style={{ width: "max-content" }} >Apellido/s</label>
                            ...
                            <div className={style.BoxSelectInmoYPropie}>
                                <div className="input-wrapper">
                                    <label htmlFor="email-garantiza" className='label-accordion' style={{ width: "max-content" }} >Email</label>
                                    <input className='input-accordion' type="text" name='Email' {...register('Email', { required: "Campo Requerido", })} />
                                    {errors.Email && (<p className="text-danger">{errors.Email.message}</p>)}
                                </div>
                                <div className="input-wrapper">
                                    <label htmlFor="telefono-garantiza" className='label-accordion' style={{ width: "max-content" }} >Teléfono de contacto</label>
                                    ...
                                    <input type="hidden" id="subject" {...register('subject')} /> {/* Campo oculto para el asunto */}
                                </div>
                            </div>
                            <div className={style.BoxSelectProvinciaYLocalidad}>
                                <div className="input-wrapper">
                                    ...
                                    <select className={style.SelectInmoYPropie} name='Provincia' {...register('Provincia', { required: "Campo Requerido", })} >
                                        <option></option>
                            ...
                            <div className={style.BoxButtonEnd}>
                                <button type='submit' className={style.ButtonBuscar}>ENVIAR</button>
                            </div>
