...
export const QuestionsProp = [
  {
    question: "¿En cuanto tiempo respondemos ante el incumplimiento de pago?",
    answer: "Nuestro tiempo de respuesta comienza a contar a partir de la fecha en la que se notifica el incumplimiento de pago y durante los próximos 10 días hábiles.",
    id: 'question01',
    height: '75px'
  },
  {
    question: "¿Quién firma el contrato de garantía?",
    answer: "La firma estará a cargo del solicitante y co-solicitante si lo hubiera y el gerente general.",
    id: 'question02',
    height: '95px'
  },
  {
    question: "¿Cómo procedo ante incumplimiento de pago?",
    answer: "Se debe notificar a Trust Fund el incumplimiento dentro de los 30 días de haberse conocido el hecho al mail info@trustfund.com.ar con los siguientes datos: nombre y apellido del inquilino, DNI, dirección de vivienda, monto adeudado y una foto de la intimación al inquilino (CD).",
    id: 'question03',
    height: '95px'
  }
];
